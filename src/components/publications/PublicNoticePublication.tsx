...
import { PublicNoticeValues } from 'interfaces/publications';
...
interface PublicationProps {
	id: number;
	data: PublicNoticeValues;
}

const PublicNoticePublication: React.FC<PublicationProps> = ({ id, data }) => {
		...
		<div
			...
			<div className="w-full">
				...
				<p className="text-[10px] leading-[16.74px] font-medium text-575555 mini:text-12 mini:leading-[20.09px] mb-3 mini:mb-[14px]">
					{getPublicationText(PUBLICATION_TYPES.PUBLIC_NOTICE, data)}
				</p>
						...
						onClick={() =>
							navigate(
								routes.getPubDetailRoute(
									`${PUBLICATION_TYPES_ACRONYMS.PUBLIC_NOTICE}-${data.reference}`
								)
							)
						}
...
export default PublicNoticePublication;
